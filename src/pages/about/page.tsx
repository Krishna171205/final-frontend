        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center">
              <button onClick={() => navigate('/')} className="text-3xl font-bold text-transparent font-serif cursor-pointer" style={{ background: 'linear-gradient(135deg, #F59E0B, #d97706)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                Rajeev Mittal
              </button>
            </div>
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                ...
                <span className="text-gold-300 px-3 py-2 text-sm font-medium">
                  About
                </span>
                <button
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mobile-menu bg-gray-900 border-t border-gray-800">
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <span className="text-gold-300 block px-3 py-2 text-base font-medium">About</span>
                ...
                <button onClick={() => navigate('/areas')} className="text-gray-300 hover:text-gold-300 block px-3 py-2 text-base font-medium cursor-pointer w-full text-left">Areas</button>
                <button onClick={() => navigate('/blogs')} className="text-gray-300 hover:text-gold-300 block px-3 py-2 text-base font-medium cursor-pointer w-full text-left">Blog</button>
